...
export interface CustomRouterV3Interface extends utils.Interface {
  functions: {
...
export type LiqEvent = TypedEvent<[BigNumber], LiqEventObject>;

export type LiqEventFilter = TypedEventFilter<LiqEvent>;

export interface LiqETHEventObject {
  arg0: BigNumber;
}
export type LiqETHEvent = TypedEvent<[BigNumber], LiqETHEventObject>;

export type LiqETHEventFilter = TypedEventFilter<LiqETHEvent>;
...
export interface CustomRouterV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CustomRouterV3Interface;
  ...
  filters: {
    "Liq(uint256)"(arg0?: null): LiqEventFilter;
    Liq(arg0?: null): LiqEventFilter;

    "LiqETH(uint256)"(arg0?: null): LiqETHEventFilter;
    LiqETH(arg0?: null): LiqETHEventFilter;
