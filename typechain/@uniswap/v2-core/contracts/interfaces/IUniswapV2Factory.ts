...
export interface IUniswapV2Factory extends BaseContract {
  ...
  functions: {
    allPairs(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string] & { pair: string }>;
  ...
  getPair(tokenA: PromiseOrValue<string>, tokenB: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
  ...
  callStatic: {
    ...
    setFeeTo(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;

    setFeeToSetter(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
  };
